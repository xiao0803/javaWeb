...
IndexSidebar.prototype.initialize = function (options) {
	...
	var chars = options.chars == "" ? "#ABCDEFGHIJKLMNOPQRSTUVWXYZ":options.chars;
	var el =  document.createElement('div')
	el.className = 'city-sidebar-container'
...
IndexSidebar.prototype.adjust = function (options) {
	...
	//alert("expectHeight:"+expectHeight);
//	if(expectHeight<450){
...
//		//alert("fontSize:"+style.fontSize);
//	}	
	var sidebar_height = this.el.offsetHeight;
	this.el.style.marginTop = (0 - sidebar_height/2 + 22) + "px";
}
