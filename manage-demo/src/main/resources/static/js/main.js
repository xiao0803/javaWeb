...
;(function($){
    ...
    var MyDropLoad = function(element, options){
        ...
        // 是否有数据
        me.isData = true;
        //数据标记,默认 “NO” 为无数据， “NO_MORE”表示无更多数据
        me.dataType = "NO";
        me._scrollTop = 0;
        me._threshold = 0;
        me.init(options);
    ...
    function fnAutoLoad(me){
        if(me.opts.autoLoad){
//        	alert("me._scrollContentHeight:"+me._scrollContentHeight
//        	+ " me._threshold: me._threshold " + me._threshold
//        	+ "  me._scrollWindowHeight:"+me._scrollWindowHeight
//        	);
